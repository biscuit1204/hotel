...
<body text=#000000 bgColor="#ffffff" leftMargin=0 topMargin=4>
	...
	<div id="main">
		<div id="tabhead" class="tab-head">
			...
			<form name=alipayment action=alipaytradepagepayjsp method=post
			target="_blank">
		...
		<form name=tradequery action=alipaytradequeryjsp method=post
			target="_blank">
		...
		<form name=traderefund action=alipaytraderefundjsp method=post
			target="_blank">
		...
		<form name=traderefundquery
			action=alipaytradefastpayrefundqueryjsp method=post
			target="_blank">
		...
		<form name=tradeclose action=alipaytradeclosejsp method=post
			target="_blank">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "餐车下单";
		document.getElementById("WIDtotal_amount").value = "${car.total}";
	}
	GetDateNow();
</script>
</html>